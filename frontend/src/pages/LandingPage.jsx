    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block bg-pastel-peach/50 dark:bg-orange-950/30 text-dark-grey dark:text-orange-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-3">Affordable Excellence</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-dark-grey dark:text-white mb-6">Our Monthly Fee Structure</h2>
          <p className="text-mid-grey dark:text-gray-400 mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <p className="text-xs text-mid-grey dark:text-gray-400 italic max-w-xs">
